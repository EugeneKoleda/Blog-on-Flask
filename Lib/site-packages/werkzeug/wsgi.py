...
def extract_path_info(
    ...
    >>> extract_path_info('http://example.com/first_app', '/first_app/hello')
    u'/hello'
    >>> extract_path_info('http://example.com/first_app',
    ...                   'https://example.com/first_app/hello')
    u'/hello'
    >>> extract_path_info('http://example.com/first_app',
    ...                   'https://example.com/first_app/hello',
...
class ClosingIterator(object):
    ...
    that::
        ...
        return ClosingIterator(first_app(environ, start_response), [cleanup_session,
                                                              cleanup_locals])
